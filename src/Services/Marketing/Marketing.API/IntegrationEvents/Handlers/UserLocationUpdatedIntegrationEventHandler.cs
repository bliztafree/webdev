namespace Microsoft.bliztafree.Services.Marketing.API.IntegrationEvents.Handlers
{
    ...
    using Microsoft.bliztafree.Services.Marketing.API.Infrastructure.Repositories;
    using System;
