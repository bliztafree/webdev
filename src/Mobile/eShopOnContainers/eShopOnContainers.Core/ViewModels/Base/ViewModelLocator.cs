using bliztafree.Core.Services.Basket;
using bliztafree.Core.Services.Catalog;
using bliztafree.Core.Services.Dependency;
using bliztafree.Core.Services.FixUri;
using bliztafree.Core.Services.Identity;
using bliztafree.Core.Services.Location;
using bliztafree.Core.Services.Marketing;
using bliztafree.Core.Services.OpenUrl;
using bliztafree.Core.Services.Order;
using bliztafree.Core.Services.RequestProvider;
using bliztafree.Core.Services.Settings;
using bliztafree.Core.Services.User;
using bliztafree.Services;
using System;
...
namespace bliztafree.Core.ViewModels.Base
{
