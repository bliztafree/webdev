...
{
    cat <<END
deploy.sh: deploys bliztafree application to Kubernetes cluster
Parameters:
...
if [[ $build_solution ]]; then
    echo "#################### Building bliztafree solution ####################"
    dotnet publish -o obj/Docker/publish ../bliztafree-ServicesAndWebApps.sln
fi

export TAG=$image_tag

if [[ $build_images ]]; then
    echo "#################### Building bliztafree Docker images ####################"
...
echo "bliztafree deployment is DONE"
